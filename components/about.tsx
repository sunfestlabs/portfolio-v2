    ...
    <div className={style.container}>
      ...
      <div className={style.about}>
        <VStack className={style.description} gap="24px">
          <p>
            Hey there, I&apos;m Chris Nivera! I&apos;m a software engineer with
            a passion for creating user-friendly interfaces that solve
            real-world problems. I first got interested in computer science
            thanks to my love for gaming, much to my parents’ initial chagrin.
            Nevertheless, the countless hours I’ve spent leaping around on Super
            Mario Brothers or coordinating with friends on League of Legends
            fuel my desire to build memorable experiences on the web.
          </p>
          <p>
